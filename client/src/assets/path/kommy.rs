...
#[rustfmt::skip] const VOC_PATH_SORROW_1: &str = concatcp!("sounds/", HERO_NAME, "/Voice_", HERO_NAME, "_Sorrow1.sound", QUERY, VERSION);
#[rustfmt::skip] const VOC_PATH_SORROW_2: &str = concatcp!("sounds/", HERO_NAME, "/Voice_", HERO_NAME, "_Sorrow2.sound", QUERY, VERSION);
#[rustfmt::skip] const VOC_PATH_SORROW_3: &str = concatcp!("sounds/", HERO_NAME, "/Voice_", HERO_NAME, "_Sorrow3.sound", QUERY, VERSION);
#[rustfmt::skip] const VOC_PATH_SORROW_4: &str = concatcp!("sounds/", HERO_NAME, "/Voice_", HERO_NAME, "_Sorrow4.sound", QUERY, VERSION);
#[rustfmt::skip] const VOC_PATH_SORROW_5: &str = concatcp!("sounds/", HERO_NAME, "/Voice_", HERO_NAME, "_Sorrow5.sound", QUERY, VERSION);
