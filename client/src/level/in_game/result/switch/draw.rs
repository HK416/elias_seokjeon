...
impl Plugin for InnerPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(
            OnEnter(LevelStates::SwitchToGameDraw),
            (
                debug_label,
                setup_scene_timer,
        ...
        .add_systems(
            OnExit(LevelStates::SwitchToGameDraw),
            (
                cleanup_scene_timer,
        ...
        .add_systems(
            ...
            (
                ...
                .run_if(in_state(LevelStates::SwitchToGameDraw)),
        );
    }
}
...
fn debug_label() {
    info!("Current Level: SwitchToGameDraw");
}
