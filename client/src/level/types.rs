...
impl Into<Hero> for Character {
    fn into(self) -> Hero {
        match self {
            Self::Alice => Hero::Alice,
            Self::Amelia => Hero::Amelia,
            Self::Ashur => Hero::Ashur,
            Self::Aya => Hero::Aya,
            Self::Belita => Hero::Belita,
            Self::Beni => Hero::Beni,
            Self::BigWood => Hero::BigWood,
            Self::Butter => Hero::Butter,
            Self::Canna => Hero::Canna,
            Self::Chloe => Hero::Chloe,
            Self::Daya => Hero::Daya,
            Self::Diana => Hero::Diana,
            Self::Elena => Hero::Elena,
            Self::Epica => Hero::Epica,
            Self::Erpin => Hero::Erpin,
            Self::Espi => Hero::Espi,
            Self::Festa => Hero::Festa,
            Self::Fricle => Hero::Fricle,
            Self::Gabia => Hero::Gabia,
            Self::Hilde => Hero::Hilde,
            Self::Ifrit => Hero::Ifrit,
            // Self::Jade => Hero::Jade,
            Self::Jubee => Hero::Jubee,
